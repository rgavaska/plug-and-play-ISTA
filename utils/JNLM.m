function [DenoisedImg, A1, M_nsy, Y_swp] = JNLM(NoisyImg, GuideImg,...
...
% This code is based on another matlab code that implements a fast version
% of standard NLM. Unfortunately I do not know where this code can be found
% online.
